 ...
 */
	...
	public:
      ...
      DiffusionCCFV (const K& k_, A0& a0_, const F& f_, const B& b_, const J& j_, const G& g_, const double Diffusion_, const double self_deg_)
        : k(k_), a0(a0_), f(f_), b(b_), j(j_), g(g_), Diffusion(Diffusion_), self_deg(self_deg_)
      {}
	  ...
	  void alpha_volume (const EG& eg, const LFSU& lfsu, const X& x, const LFSV& lfsv, R& r) const
	  {
        ...
        //for (size_t i=0; i<lfsu.size(); i++)
           y = KAPPA*degradation_local[0] + self_deg;

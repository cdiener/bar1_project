...
void driver_dg (const GV& gv, const PGMap& pg, int dg_method, double dt, double tend, bool vtk)
{
  ...
  /*typedef Dune::PDELab::StationaryLinearProblemSolver<IGOS,LS,U0> PDESOLVER;
  PDESOLVER pdesolver(igos,ls,1e-10);
  typedef Dune::PDELab::StationaryLinearProblemSolver<IGOS1,LS1,U1> PDESOLVER1;
  PDESOLVER1 pdesolver1(igos1,ls1,1e-10);*/
  ...
  Dune::PDELab::FilenameHelper fn("../output/sol");              // append number to file name

 ...
 */
    ...
    class DiffusionDG :
      ...
      //public NumericalJacobianVolume<DiffusionDG<K, F, B, G, J,Degradation> >,
      //public NumericalJacobianSkeleton<DiffusionDG<K, F, B, G, J,Degradation> >,
      //public NumericalJacobianBoundary<DiffusionDG<K, F, B, G, J,Degradation> >
    {
    public:
    ...
    void update (Degradation& degradation_) { degradation = degradation_; }
